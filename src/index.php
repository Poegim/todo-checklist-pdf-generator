...
<body class="bg-gradient-to-br from-slate-50 to-slate-300 w-full pt-10 flex justify-center pb-8 min-h-screen"
  x-data="{list: [], inputValue: '', title: ''}">
  <div class="max-w-7xl mt-4 rounded-lg bg-gray-200 p-4">
  ...
  <div class=" w-full flex justify-center mt-4">
      ...
      <div class="w-full flex justify-center mt-4">
        <div>
          ...
          <button @click="list.push(inputValue); inputValue = '';" type="button"
            class="text-md px-8 py-1 rounded bg-gradient-to-tr from-green-200 to-blue-400 hover:from-green-300 hover:to-blue-500 hover:border-gray-100 shadow border-2 border-white">Add</button>
          <button @click="list.pop(); inputValue = '';" type="button"
            class="text-md px-8 py-1 rounded bg-gradient-to-tr from-red-600 to-violet-500 hover:from-red-700 text-white hover:to-violet-600 hover:border-gray-100 shadow border-2 border-white">Remove</button>
        </div>
      </div>
      ...
      <div class="w-full flex justify-center">
        <button type="button" id="print_btn"
          class="text-md px-8 py-1 rounded bg-gradient-to-tr from-violet-200 to-orange-400 hover:from-violet-300 hover:to-orange-500 hover:border-gray-100 shadow border-2 border-white mt-8">Print</button>
      </div>
    </div>
    <script>
